The codes try to investigate multipartite nonlocality spectrum in the ground states of infinite-size translation invariant spin-1/2 chains.

The algorithma are from Ref. [1]-[2].

Before using the codes, you need to prepare an iMPS.m which contains the ground state.
iMPS.m defines a cell array in the form of:
